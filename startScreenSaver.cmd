...
::**********************************************************************
SET $NAME=%~n0
SET $DESCRIPTION=Start Windows screensaver
...
::@ (#)  Author:
::@ (#)  URL: http://boards.straightdope.com/sdmb/showthread.php?t=612612
::@ (#) 
::@(#)
::@(#)SOURCE
...
:ScreenSaver
    ...
    @START /MIN %windir%\system32\PhotoScreensaver.scr -s
GOTO :EOF
