...
:_UnitTest__utc
    ...
    :: Create ref
     ...
     REM >"%TEMP%\%0.ref" 2>>"%TEMP%\%0.trc" ECHO 0
    REM >>"%TEMP%\%0.ref" 2>>"%TEMP%\%0.trc" ECHO 0
     
    REM CALL HexDump.cmd /A /O "%TEMP%\%0.ref" >"%TEMP%\%0.hexref" 2>>"%TEMP%\%0.trc"
    
    :: Dump test data
    >"%TEMP%\%0.dump" 2>>"%TEMP%\%0.trc" ( CALL %0 &set utc )


GOTO :EOF *** _utc ***

    >"%TEMP%\%0.out" 2>>"%TEMP%\%0.trc" ( CALL %0 &set utc )
...
::::UTC=2014-02-07T09:08:45
::MATCH::^UTC=20[012][0-9]-[01][0-9]-[0-3][0-9]T[0-2][0-9]:[0-5][0-9]:[0-5][0-9]
::
::::UTC_FILE=2015-03-31T11-46-50.598000+120
::::UTC_FILE=2015-11-13T08-16-19-37

::                 YY Y    Y   - M   M   - D    D   T H    H   - m    m   - s    s   . h    h    h    h    h    h   + z    z    z
::MAT CH::^UTC_FILE=20[012][0-9]-[01][0-9]-[0-3][0-9]T[0-2][0-9]-[0-5][0-9]-[0-5][0-9].[0-9][0-9][0-9][0-9][0-9][0-9].[0-9][0-9][0-9]$
::MAT CH::^UTC_FILE=.*T.*\.[0-9][0-9][0-9][0-9][0-9][0-9]\+[0-9][0-9][0-9]
::MATCH::^UTC_FILE=20[012][0-9]-[01][0-9]-[0-3][0-9]T[0-2][0-9]-[0-5][0-9]-[0-5][0-9].
