...
::**********************************************************************
SET $NAME=%~n0
SET $DESCRIPTION=Gets quarter of year for a given date
...
::ENDLOCAL
    ...
    SET QuarterOfYear
    ENDLOCAL&SET QuarterOfYear=%QuarterOfYear%
GOTO :EOF    

::  :: Get Quarter of year (1-4)
::  FOR /f %%a in ('WMIC path win32_localtime get Quarter /format:list ^| FIND "="') DO CALL SET %%a
::  SET Quarter
